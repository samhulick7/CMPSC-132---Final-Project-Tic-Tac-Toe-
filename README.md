...
3. Respond to the command prompts that ask for the row and column index of the play. In order for a play to be marked on the board, the row and column of the play must be an integer between 0-2, or else the play will be ruled invalid and the terminal will re-ask the player.
